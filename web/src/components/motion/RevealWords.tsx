  ...
  return (
    <span className={className}>
      ...
      {words.map((word, i) => {
        ...
        return (
          // A word can't wrap mid-mask, so each gets its own clipped line box, with
          // its trailing space riding inside it.
          <span key={`${word}-${i}`} className="-mb-[0.08em] inline-block overflow-hidden pb-[0.08em] align-bottom">
            <motion.span
